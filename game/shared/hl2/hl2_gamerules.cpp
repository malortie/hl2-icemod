...
#if defined ( ICEMOD_DLL ) || defined ( ICEMOD_CLIENT_DLL )
...
#endif // defined ( ICEMOD_DLL ) || defined ( ICEMOD_CLIENT_DLL )
...
#if defined ( ICEMOD_DLL ) || defined ( ICEMOD_CLIENT_DLL )
		//ICE
		def.AddAmmoType("AtomSmasher",		DMG_SHOCK,					TRACER_NONE,			0,	0,	260, 0, 0 );
		def.AddAmmoType("MobileTurretAmmo",	DMG_BULLET,					TRACER_NONE,			0, 0, 3, 0, 0 );
#endif // defined ( ICEMOD_DLL ) || defined ( ICEMOD_CLIENT_DLL )
