...
//			bitsDamageType - 
//-----------------------------------------------------------------------------
void CNPC_Zeus::TraceAttack(const CTakeDamageInfo &inputInfo, const Vector &vecDir, trace_t *ptr, CDmgAccumulator *pAccumulator)
{
...
void CNPC_Zeus::InputStartDeathSequence( inputdata_t &inputdata )
{
	...
	if( !IsCurSchedule(SCHED_ZEUS_DEATH_SEQUENCE) )
	{
		...
		if ( m_pSmoke )
		{
			m_pSmoke->m_SpawnRate			= 20;
			m_pSmoke->m_ParticleLifetime	= 7.0;
			m_pSmoke->m_StartSize			= 20;
			m_pSmoke->m_EndSize				= 120;
			m_pSmoke->m_SpawnRadius			= 64;
