...
#if defined ( ICEMOD_DLL )
			UTIL_BloodImpact(vecSpot, vecDir, BloodColor(), 1); // ICE changed BloodColor() to BLOOD_COLOR_RED
#else
...
#if defined ( ICEMOD_DLL )
			if (UTIL_ShouldShowBlood(BloodColor())) // ICEmod YELLOW to RED
#else
			if( UTIL_ShouldShowBlood(BLOOD_COLOR_YELLOW) )
#endif // defined ( ICEMOD_DLL )
			{
#if defined ( ICEMOD_DLL )
				UTIL_BloodImpact(pGib->WorldSpaceCenter(), Vector(0, 0, 1), BloodColor(), 1); // ICEmod YELLOW to RED
#else
...
#if defined ( ICEMOD_DLL )
					UTIL_BloodDrips(vecSpot, vec3_origin, BloodColor(), 50); // ICEmod YELLOW to RED
#else
					UTIL_BloodDrips( vecSpot, vec3_origin, BLOOD_COLOR_YELLOW, 50 );
#endif // defined ( ICEMOD_DLL )
				}
