...
#if defined ( ICEMOD_CLIENT_DLL )

	// ICEMOD
	bool			IsHelmetEquipped( void ) { return m_Local.m_bWearingHelmet; }
	// Helmet Effects
	int				GetHelmetDamageAlpha( void ){ return m_Local.m_iHelmetDamageAlpha; }
	int				GetHelmetBloodAlpha( void ){ return m_Local.m_iHelmetBloodAlpha; }
	int				GetHelmetBloodColor( void ){ return m_Local.m_iHelmetBloodColor; }
...
#endif // defined ( ICEMOD_CLIENT_DLL )
