...
class C_NPC_Icedog : public C_AI_BaseNPC
{
public:
	C_NPC_Icedog() {}

	DECLARE_CLASS( C_NPC_Icedog, C_AI_BaseNPC );
	DECLARE_CLIENTCLASS();
 	DECLARE_DATADESC();
...
private:
	...
	C_NPC_Icedog( const C_NPC_Icedog & );
};
...
// Networking
//-----------------------------------------------------------------------------
IMPLEMENT_CLIENTCLASS_DT(C_NPC_Icedog, DT_NPC_Icedog, CNPC_Icedog)
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_NPC_Icedog::OnDataChanged( DataUpdateType_t type )
{
...
//-----------------------------------------------------------------------------
//-----------------------------------------------------------------------------
void C_NPC_Icedog::UpdateBleedingPerformance()
{
	// get my particles
